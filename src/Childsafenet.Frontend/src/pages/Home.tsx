    ...
    <div className="stack">
      <section className="hero">
        <div className="heroLeft">
          ...
          <p className="heroDesc">
            Hệ thống kết hợp <b>AI Classification</b> và <b>Chính sách phụ huynh</b> để phát hiện URL nguy hiểm
          ...
          <div className="miniNote">
            Tip: Nếu bạn chưa có tài khoản, hãy tạo tài khoản.
          </div>
        </div>
      ...
      <section className="grid3">
        <Card>
          ...
          <div className="cardText">Nhập URL để AI phân tích và hiển thị kết quả và giải thích.</div>
        </Card>
        <Card>
          <div className="cardTitle">Dashboard</div>
          <div className="cardText">Thống kê nhanh và lịch sử giám sát theo từng phụ huynh.</div>
        </Card>
        <Card>
          <div className="cardTitle">Extension Ready</div>
          <div className="cardText">Có thể chặn trực tiếp khi action = BLOCK.</div>
        </Card>
      </section>
    </div>
  );
